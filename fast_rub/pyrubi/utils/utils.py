...
class Utils:
    ...
    @staticmethod
    def privateParse(private: str) -> str | None:
        if private:
    ...
    @staticmethod
    def isChatType(chatType: str) -> bool | None:
    ...
    @staticmethod
    def isMessageType(messageType: str) -> bool | None:
    ...
    @staticmethod
    def getChatTypeByLink(link: str) -> str | None:
    ...
    @staticmethod
    def checkLink(url: str) -> bool | None:
        for i in ["http:/", "https://"]:
            if url.startswith(i):
                return True
    ...
    def generateFileName(mime: str) -> str:
        return f"Pyrubi Library {randint(1, 1000)}.{mime}"

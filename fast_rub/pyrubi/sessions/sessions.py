...
class Sessions:
    ...
    async def createSession(self):
        ...
        while True:
            ...
            try:
                sendCodeData: dict = await methods.sendCode(phoneNumber=phoneNumber)
            except:
            ...
            if sendCodeData['status'] == 'SendPassKey':
                while True:
                    ...
                    sendCodeData: dict = await methods.sendCode(phoneNumber=phoneNumber, passKey=passKey)
            ...
            while True:
                ...
                signInData: dict = await methods.signIn(phoneNumber=phoneNumber, phoneCodeHash=sendCodeData['phone_code_hash'], phoneCode=phoneCode)

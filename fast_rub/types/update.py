...
class Update:
    ...
    @property
    def meta_data_parts(self) -> metadata_prop | None:
    ...
    def is_fowrard(self) -> bool:
        self._client.logger.warn("The 'warn' method is deprecated, "
    ...
    def sticker_sticker_id(self) -> str | None:
        ...
        return None
    @property
    def sticker_file(self) -> File | dict:

...
class msg_update:
    ...
    def message_id(self) -> str:
        ...
        return self.update_data["message_id"] if self.update_data.get("message_id") else self.update_data["new_message_id"]
    ...
    async def get_message(self) -> Update | None:
    ...
    async def delete_message(self) -> props:
        ...
        return await self.client.delete_message(self.chat_id, self.message_id) # type: ignore
...
wrap_all_async_methods(msg_update)
